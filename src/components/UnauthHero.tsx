  ...
  <div className="min-h-screen bg-sand text-[#3b0014] font-sans">
      ...
      <div className="relative h-screen flex flex-col overflow-hidden">
        ...
        <div className="flex h-1/5 relative">
          <div className="w-full bg-[#3b0014]/30"></div>
        ...
        {/* Content Section */}
        <div className="h-4/5 bg-[#f0e7c2] relative">
          <div className="max-w-4xl mx-auto px-6 text-center pt-16">
            ...
            >
              <h1 className="font-serif text-5xl md:text-6xl mb-6 text-[#3b0014]  font-bold"   style={{ fontFamily: "'Dancing Script', cursive" }}>
              ...
              <Link href='/login' className="ative px-8 py-4 bg-[#3b0014] text-white text-lg  shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1  rounded  cursor-pointer whitespace-nowrap">
                Start Your Journey
              </Link>
            </div>
          </div>
