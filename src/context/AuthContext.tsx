...
// 🎯 الهدف من استخدام Context
// لما اليوزر يسجل دخول أو يعمل sign up، بتكوني بدك:

// تعرفي إذا هو مسجل دخول أو لا

// تخزني معلوماته عشان تستخدميها بكل الصفحات (مثل الـ username أو الـ bio)

// تعملي تحديث أو logout بسهولة

// ولأن هاي البيانات مطلوبة في عدة أماكن بالموقع (نافبار، صفحة البروفايل، الصفحة الرئيسية...)، ما بصير تبقي تمرريها بـ props، لازم يكون في طريقة مركزية تمسك الحالة.

// عشان هيك بنستخدم React Context API.

// 4. استخدام AuthContext في كل مكان
// بعد هيك، في أي مكان بالموقع، مثل:

// Navbar → بتعرفي اسم المستخدم

// صفحة البروفايل → بتجيبي معلوماته

// زر إضافة مدونة → بتعرفي uid تبعه

// صفحة التفاصيل → بتقرني مين صاحب المدونة

// كل هذا بسهولة باستخدام hook:
